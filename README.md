This repository contains the code for a personal website showcasing skills, experience, and contact information.  The site is built using HTML, CSS, and JavaScript, and features:
